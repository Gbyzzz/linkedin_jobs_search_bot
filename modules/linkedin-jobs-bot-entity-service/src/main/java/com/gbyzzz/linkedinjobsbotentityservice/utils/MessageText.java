package com.gbyzzz.linkedinjobsbotentityservice.utils;
...
public abstract class MessageText {
    ...
    public static final String SAVED_SUCCESSFUL = "Your search params have been saved successfully, " +
    ...
    public static final String ADD_WORKPLACE_REPLY = "Enter keywords that should be included" +
            "(separate them by space) \n If you don't want this filter just input '-' (minus):";
    ...
    public static final String ADD_FILTER_INCLUDE_REPLY_END = """
            ...
            Please enter keywords, that\
             shouldn't be in the jobs name (separate them by space)\s
             If you don't want this filter\
             just input '-' (minus):""";
